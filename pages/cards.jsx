...
export default function CardsPage() {
  ...
  useEffect(() => {
    if (user?.club_address) fetchCards();
  }, [user, activeTab, sortNewestFirst]);
  ...
  return (
    <div className={styles.container}>
      <div className={styles.header}>
        <h1 className={styles.title}>Карточки объектов ({user?.club_address})</h1>
        <button className={styles.navButton} onClick={() => router.push('/')}>На главную</button>
      </div>
